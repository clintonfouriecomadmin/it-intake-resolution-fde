...
// This route was the one that surfaced the caching bug directly:
// classifiedCount stayed at 0 in ~10ms response times (a cache hit) even
// after real classifications existed. See lib/supabaseServer.ts.
