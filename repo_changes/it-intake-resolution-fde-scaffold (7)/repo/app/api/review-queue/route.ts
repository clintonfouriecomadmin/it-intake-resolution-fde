...
// See lib/supabaseServer.ts — this route was one of the two (with
// /api/metrics) that exhibited the real Next.js 14 + supabase-js caching
// bug: without both this segment config AND the no-store fetch override in
// the shared client, this route could keep serving a stale queue even after
// new tickets were classified.
