...
// Prevents Next.js from caching this route's GET response, and — combined
// with lib/supabaseServer.ts — prevents the underlying Supabase fetch from
// being cached either. See lib/supabaseServer.ts for the full explanation.
